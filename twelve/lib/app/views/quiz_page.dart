...
class QuizPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    controller.loadQuestions(name).then((value) => controller.startTimer(quizDuration.inSeconds),);
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                            ...
                            width: controller.selectedOption.value == option ? 2 : 1,
                          ),
                        ),
                        child: Row(
                          children: [
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: controller.selectedOption.value == option
                                      ...
                                      : textColor,
                                  fontSize: 16,
                                  fontWeight: controller.selectedOption.value == option
                                      ? FontWeight.w600
                                      : FontWeight.normal,
                                ),
                              ),
      ...
      child: Row(
        children: [
          ...
          if (controller.currentIndex.value < controller.questions.length - 1)
            TextButton(
              onPressed: controller.selectedOption.value.isNotEmpty ? null : () {
  ...
  void _showResults() {
    final scorePercentage = (controller.score.value / controller.questions.length) * 100;
