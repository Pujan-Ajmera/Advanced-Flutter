...
class QuizController extends GetxController {
  ...
  void nextQuestion() {
    if (selectedOption.value == questions[currentIndex.value].answer) {
      ...
      var wrongQuestion = {
        'question' : questions[currentIndex.value].question,
        'selectedOption' : selectedOption.value.isEmpty?"You Skipped this question": selectedOption.value,
        'correctOption' : questions[currentIndex.value].answer
      };
